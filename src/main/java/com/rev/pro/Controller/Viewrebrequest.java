...
public class Viewrebrequest extends HttpServlet {
	static Logger logger = Logger.getLogger("Viewrebrequest.class");
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		logger.info("=============================== Manager view Approved deny  controller ==================================");
		...
		List<ReimbursementEntity> rlist=ersservice.viewAllEmpRequest();
